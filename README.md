...
1. for function changePizzaSizes manipulate the Offset width for elements and windows out side the loop and send them as parameter in determineDx function.
